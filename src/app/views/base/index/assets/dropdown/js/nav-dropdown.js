...
(function (b) {
  var g = b.fn.navDropdown,
    ...
    h = (function () {
      ...
      a.prototype.parent = function () {
        return new a(
          b(this).map(function () {
            ...
            return c.is(":upper")
              ? null
              : b(c.is(":toggle") ? this.parentNode.parentNode : this)
                  .closest(".dropdown")
      ...
      a.prototype.children = function (c) {
        ...
        b(this).each(function () {
          ...
          (c
            ...
            (c && !this.offsetWidth && !this.offsetHeight) ||
              this.disabled ||
              b(this).is("[data-button]") ||
      ...
      a.prototype.jump = function (c) {
        ...
        var e = this.eq(0);
        e =
          this.is(":flat") || e.is(":upper")
            ? e.root().children(this.is(":flat"))
            : e.parent().children();
      ...
      a.prototype.prop = function (a, e) {
        return arguments.length
          ? 1 < arguments.length
            ...
            ? (b.extend(this.props, arguments[0]), this)
            : a in this.props
            ? this.props[a]
            : null
          : b.extend({}, this.props);
  ...
  f.prototype.toggle = function (a) {
    ...
    f._clearMenus(
      b.Event("click", { target: this, data: { toggles: d ? [this] : null } })
    );
    if (c) return !1;
      ...
      if (a.target) {
        if (this === document)
          if (b(a.target).is("a:not([disabled], .disabled)"))
            ...
            var g =
              (a.targetWrapper && b(a.targetWrapper).find(".nav-dropdown")) ||
              b(a.target).closest(".nav-dropdown");
            if (f._isCollapsed(g)) return;
          }
        else if (
          b(a.target).hasClass("dropdown-backdrop") &&
          ((g = b(a.target).next()), g.is(".nav-dropdown") && f._isCollapsed(g))
        )
          return;
        b(a.target).is('[data-toggle="dropdown-submenu"]')
          ? (c = b(a.target.parentNode)
              .parents(".dropdown")
      ...
      c =
        (a.data &&
          ...
          b(a.data.toggles)
            .parent()
            .find('[data-toggle="dropdown-submenu"]')) ||
        b.makeArray(b('[data-toggle="dropdown-submenu"]').not(c));
      for (g = 0; g < c.length; g++) {
        ...
        if (
          ...
          ("click" !== a.type ||
            ...
            !b.contains(h, a.target))
        ) {
          var l = b.Event("hide.bs.nav-dropdown", k);
          b(h).trigger(l);
          l.isDefaultPrevented() ||
            (c[g].setAttribute("aria-expanded", "false"),
            b(h)
              .removeClass("open")
              .trigger(b.Event("hidden.bs.nav-dropdown", k)));
        }
      }
      ...
      c &&
        ...
        a.which == d.ESC
          ...
          : "A" == a.target.tagName &&
            ...
            c.is(":flat")
              ? a.which === d.DOWN || a.which === d.UP
                ? c[a.which === d.UP ? "prev" : "next"]().focus()
                : a.which === d.LEFT
                ? c.is(":opened")
                  ? c.close()
                  : c.parent().close().focus()
                : a.which === d.RIGHT && c.is(":toggle") && c.open()
              : c.is(":upper")
              ? a.which === d.LEFT || a.which === d.RIGHT
                ? (c[a.which === d.LEFT ? "prev" : "next"]().focus().open(),
                  c.is(":toggle") && c.close())
                : (a.which !== d.DOWN && a.which !== d.UP) ||
                  !c.is(":toggle") ||
                  c.children()[a.which === d.DOWN ? "first" : "last"]().focus()
              : a.which === d.LEFT
              ? ((a = c.parent()),
                a.is(":upper")
              ...
              ? ((a = c.children()),
                a.length
                  ? (c.open(), a.first().focus())
                  : c.parents(":upper").close().next().focus().open())
              : (a.which !== d.DOWN && a.which !== d.UP) ||
                c[a.which === d.UP ? "prev" : "next"]().focus()));
    }
  };
  f._isCollapsed = function (a) {
    ...
    return (
      ...
      window.innerWidth < k[b[1].toUpperCase()]
    );
  };
  f._dataApiResizeHandler = function () {
    b(".nav-dropdown").each(function () {
      ...
      a != b(this).hasClass("nav-dropdown-sm") &&
        (a
          ? b(this).addClass("nav-dropdown-sm")
          : b(this).removeClass("nav-dropdown-sm"));
    });
  };
